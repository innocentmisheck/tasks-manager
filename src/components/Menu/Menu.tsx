  ...
  return (
    ...
    >
      <header className="h-full flex flex-col">
        <h3 className="font-bold text-rose:600 text-center mt-8 text-lg tracking-wide hidden xl:block">
          21st Generation
        </h3> 
        <h3 className="font-bold uppercase text-center text-lg tracking-wide hidden xl:block">
          Task Management
        </h3>
