    ...
    >
      <section className="p-5 flex flex-col h-full">
        <span className="flex items-center mx-auto">
          <span className="font-medium">Media and Communication</span>
          <img src={avatar1} alt="accountimage" className="w-10 rounded-full ml-4" />
        </span>
        ...
        <DeleteTasks />
        <a
          href="https://github.com/innocentmisheck"
